...
def main():
    ...
    try:
        ...
        # 3. SELECT YOUR HAND画面
        print("3. Testing show_choice_prompt()...")
        display.show_choice_prompt()
        time.sleep(2)

        # 4. プレイヤーの手表示
        print("4. Testing show_hand() for player...")
        ...
        # 5. VS画面
        print("5. Testing show_vs_screen()...")
        display.show_vs_screen('rock', 'scissors')
        time.sleep(2)

        # 6. 結果画面
        print("6. Testing show_result()...")
